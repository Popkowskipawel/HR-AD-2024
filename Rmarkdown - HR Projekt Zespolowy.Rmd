...
```
P-value jest znacznie mniejsze niż 0.05, co oznacza, że różnica wieku między grupami Attrition (Yes vs. No) jest istotna statystycznie.
...
średnie wynagrodzenie w grupie "No" (pracownicy, którzy zostali) jest wyższe (Me = 5204) niż w grupie "Yes" (pracownicy, którzy odeszli) (Me = 3270.50).
...
print(t_test_result)
```
Bardzo mała wartość p-value(< 0.05)
Odrzucamy hipotezę zerową H₀ → Wynagrodzenie istotnie różni się między grupami.
t = -10.5

Wysoka wartość bezwzględna t oznacza dużą różnicę między grupami.
95% przedział ufności: [-2150.24, -1350.56]

Przedział nie obejmuje zera, więc różnica jest istotna statystycznie.
Oznacza to, że średnie wynagrodzenie osób, które odeszły, było od 1350 do 2150 niższe niż tych, którzy zostali.
