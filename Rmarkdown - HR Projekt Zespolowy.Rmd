...
P-value jest znacznie mniejsze niż 0.05, co oznacza, że różnica wieku między grupami Attrition (Yes vs. No) jest istotna statystycznie. Porównanie dokładne parami
...
print(t_test_result)
{r results='asis'}
t.test(MonthlyIncome ~ Attrition, data = df, var.equal = FALSE)
```
