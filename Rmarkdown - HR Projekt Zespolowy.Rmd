...
Z kolei wykres słupkowy ilustruje procentowy udział rotacji pracowników według stanowiska. Wartość 0 oraz kolor czerwony oznaczają pracowników, którzy zdecydowali się pozostać w firmie. Wartość 1 oraz kolor turkusowy oznaczają osoby, które odeszły z firmy.
...
Z wykresu można zauważyć większą tendencję do rotacji pracowników w młodszym wieku. Wraz ze wzrostem wieku, poza niewielkimi wyjątkami, wzrasta również rotacja.
